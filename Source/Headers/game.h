...
extern const PhysicsConsts		kDefaultPhysicsConsts;
...
extern int						gVehicleParameters[NUM_CAR_TYPES_TOTAL][NUM_VEHICLE_PARAMETERS];
...
extern PhysicsConsts			gPhysicsConsts;
